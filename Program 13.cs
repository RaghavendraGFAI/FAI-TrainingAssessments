...
namespace Program13
{
    ...
    class Assignment13
    {
        ...
        {
            writeToFile(new Patient { Name = "Manoj", PhoneNo = 9988776655, BillAmount = 600 });
            Console.WriteLine(readFromFile());
            writeToFile(new Patient { Name = "Dhanush", PhoneNo = 9845342211, BillAmount = 1000 });
            Console.WriteLine(readFromFile());
            writeToFile(new Patient { Name = "Vishnu", PhoneNo = 8194584481, BillAmount = 2000 });
            Console.WriteLine(readFromFile());
        }
    }
}